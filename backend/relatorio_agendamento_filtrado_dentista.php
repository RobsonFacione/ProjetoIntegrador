...
if ($result->num_rows > 0) {
    ...
    for ($i = 1; $i <= $total_paginas; $i++) {
        echo "<a href='relatorio_agendamento_filtrado_dentista.php?dentista=$dentista&data_inicio=$data_inicio&data_fim=$data_fim&pagina=$i'>$i</a> ";
    }
    echo "</div>";
    ...
    echo "<br><br>";
    echo "<a href='relatorio_agendamento_filtrado_dentista_pdf.php?dentista=$dentista&data_inicio=$data_inicio&data_fim=$data_fim'>Gerar PDF</a><br><br>";
    echo "<a href='busca_dentista.html' id='botaovoltar'>Voltar</a>";
} else {
